    ...
    <NierShell>
      <div className="flex flex-col gap-6">
        <p className="font-sans text-sm leading-relaxed text-foreground/70">
          Places I've called home and places I've visited. Mostly motivated by
          transit infrastructure, cities, and the occasional conference. Zoom
          out to see all places as markers.{" "}
          <i>Last updated February 22, 2026</i>
        </p>
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
          <NierWindow title="Countries">
            <p className="text-center font-sans text-2xl font-light text-foreground/80">
              17
            </p>
          </NierWindow>
