      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:gap-8">
        ...
        <div className="flex flex-1 flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <NierStatRow label="Currently" value="Building things in Rust and Go" />
            <NierStatRow label="Thinking of" value="Transit systems, flying, clean code" />
          ...
          <div className="flex flex-col gap-4">
            <p className="font-sans text-sm leading-relaxed text-foreground/85">
              ...
              I've been writing code since I was 9 and that early obsession grew into a career
              focused on scalable infrastructure and great developer tooling.
            </p>
            <p className="font-sans text-sm leading-relaxed text-foreground/85">
              Outside of work, you'll find me exploring transit
              networks across Europe and the world, photographing my cats
              or deep in aviation rabbit holes.
            </p>
          </div>
