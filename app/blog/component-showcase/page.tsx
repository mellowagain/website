            ...
            <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        <span className="font-mono text-xs text-muted-foreground/60">2026-02-21</span>
                ...
                <section id="intro" className="flex flex-col gap-4">
                    <p className="font-sans text-sm leading-relaxed text-foreground/85">
                        When I first played Nier: Automata, the menu UI captivated me just as much as the story. The warm parchment tones,
                        the geometric line decorations, the small rotating square bullets next to each menu option -- it all felt deliberate
                        and beautiful. So I decided to build a component system inspired by it.
                    </p>
                    <p className="font-sans text-sm leading-relaxed text-foreground/85">
                        This post is a living showcase of every component used on this site. Each section below demonstrates the components
                        with interactive examples, all themed with the same dark Nier palette you see across the rest of mari.zip.
                    </p>
                </section>
                ...
                <section id="custom" className="flex flex-col gap-8">
                    ...
                    <h3 className="font-sans text-base font-medium text-foreground/90">NierWindow</h3>
                    <p className="font-sans text-sm text-foreground/70">
                        The core container. A muted header bar with a square bullet icon, followed by a body area. Used everywhere for
                        grouping content.
                    </p>
                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        ...
                        <NierWindow title="Mission Log">
                            <p className="font-sans text-sm leading-relaxed text-foreground/85">
                                Reconnaissance of the abandoned factory sector complete. Machine lifeform activity detected at grid
                                reference 7-Alpha. Awaiting further orders from Command.
                            </p>
                        </NierWindow>
                    </div>
                    ...
                    <h3 className="font-sans text-base font-medium text-foreground/90">NierMenu</h3>
                    <p className="font-sans text-sm text-foreground/70">
                        The sidebar navigation. Active items get an inverted bar with a diamond cursor. Inactive items are semi-transparent
                        strips. Square bullets rotate 45 degrees on hover.
                    </p>
                    <div className="w-64">
                        <NierMenu activeSection={demoMenuActive} onSectionChange={setDemoMenuActive} />
                    </div>

                    <Separator className="bg-border/20" />

                    <h3 className="font-sans text-base font-medium text-foreground/90">NierPortrait</h3>
                    <p className="font-sans text-sm text-foreground/70">
                        A tall narrow image container with a warm sepia filter that reveals the original colors on hover. Hover the image
                        below to see it.
                    </p>
                    <div className="flex gap-4">
                        <div className="w-36">
                            <NierPortrait src="/images/portrait.jpg" alt="Showcase portrait" />
                        </div>
                    </div>

                    <Separator className="bg-border/20" />

                    <h3 className="font-sans text-base font-medium text-foreground/90">NierStatRow</h3>
                    <p className="font-sans text-sm text-foreground/70">
                        Label-value pairs connected by a decorative dotted line. Commonly used inside NierWindow for character stats,
                        metadata, or key-value displays.
                    </p>
                    ...
                    <NierWindow title="Text Fields">
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <Input id="disabled-input" placeholder="Access denied" disabled />
                            </div>
                        </div>
                    </NierWindow>
                ...
                <section id="data" className="flex flex-col gap-8">
                    <SectionHeading title="Data Display" description="Cards, accordions, and tabs for organizing structured information." />

                    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <Card>
                            <CardHeader>
                                <CardTitle>Weapon: Virtuous Contract</CardTitle>
                                <CardDescription>A white katana used by YoRHa units.</CardDescription>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>A black katana paired with Virtuous Contract.</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="flex flex-col gap-1 text-sm">
                                    <div className="flex justify-between">
                    ...
                    <NierWindow title="Accordion">
                        <Accordion type="single" collapsible>
                            <AccordionItem value="machines">
                                ...
                                <AccordionContent>
                                    Alien-created robots that have developed a rudimentary form of consciousness. They mimic human behavior
                                    in increasingly complex ways and have begun forming their own societies.
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="yorha">
                                <AccordionTrigger>YoRHa</AccordionTrigger>
                                <AccordionContent>
                                    An elite android military force created to fight the machine lifeforms on behalf of humanity. They
                                    operate from an orbital base known as the Bunker.
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="pods">
                                <AccordionTrigger>Tactical Support Pods</AccordionTrigger>
                                <AccordionContent>
                                    Autonomous support units assigned to YoRHa androids. They provide ranged fire support, utility
                                    functions, and strategic analysis during combat operations.
                                </AccordionContent>
                            </AccordionItem>
                        </Accordion>
                    </NierWindow>
                        ...
                        <Tabs defaultValue="weapons">
                            ...
                            <TabsContent value="weapons" className="mt-4">
                                <div className="flex flex-col gap-2 text-sm text-foreground/85">
                                    <p>Small Swords: Virtuous Contract, Cruel Oath, Type-3 Sword</p>
                                    <p>Large Swords: Virtuous Treaty, Cruel Blood Oath, Iron Pipe</p>
                                    <p>Spears: Virtuous Dignity, Cruel Arrogance, Type-3 Lance</p>
                                </div>
                            </TabsContent>
                            <TabsContent value="items" className="mt-4">
                                <div className="flex flex-col gap-2 text-sm text-foreground/85">
                                    <p>Recovery: Small Recovery, Medium Recovery, Large Recovery</p>
                                    <p>Boost: Strength Up (S), Strength Up (M), Strength Up (L)</p>
                ...
                <section id="layout" className="flex flex-col gap-8">
                    <SectionHeading title="Layout" description="Separators, nested windows, and grid compositions." />

                    <NierWindow title="Separators">
                        <div className="flex flex-col gap-4">
                            <p className="text-sm text-foreground/85">Content above the separator</p>
                            <Separator />
                            <p className="text-sm text-foreground/85">Content below the separator</p>
                            ...
                            <NierWindow title="Primary Panel">
                                <div className="flex flex-col gap-3">
                                    <p className="text-sm text-foreground/85">
                                        Main content area. The 3:2 grid split mirrors the game inventory screen where items are listed on
                                        the left and details are shown on the right.
                                    </p>
                                    <NierWindow title="Nested Window">
                                        <p className="text-sm text-foreground/85">
                                            Windows can be nested to create deeper hierarchies, similar to sub-menus in the game interface.
                                        </p>
                                    </NierWindow>
                                </div>
                            </NierWindow>
                        ...
                        {["Alpha", "Beta", "Gamma", "Delta"].map((name, i) => (
                            <NierWindow key={name} title={`Sector ${name}`}>
                                <div className="flex flex-col items-center gap-1 py-2">
                                    <span className="text-2xl font-light text-foreground/60">{[42, 87, 13, 56][i]}</span>
                    ...
                    <NierWindow title="Operator Terminal">
                        <div className="flex flex-col gap-5">
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex gap-2">
                                    <Input id="terminal-cmd" placeholder="Enter command..." className="flex-1" />
                            ...
                            <Textarea placeholder="Transmission log will appear here..." className="min-h-20" />
...
function SectionHeading({ title, description }: { title: string; description: string }) {
    return (
        <div className="flex flex-col gap-1">
            <h2 className="font-sans text-lg font-medium tracking-wide text-foreground">{title}</h2>
            <p className="font-sans text-sm font-light text-muted-foreground">{description}</p>
        </div>
    );
}
