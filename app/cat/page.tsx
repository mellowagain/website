  ...
  return (
    <NierShell>
      <div className="flex flex-col gap-6">
        <NierWindow title="Mysta">
          <div className="flex flex-col gap-5 md:flex-row md:gap-6">
            ...
            <div className="flex flex-1 flex-col">
              ...
              <NierStatRow
                label="Personality"
                value="Clingy, cute, always sleepy"
              />
        ...
        <p className="font-sans text-xs uppercase tracking-[0.2em] text-muted-foreground/50">
          Gallery
        </p>
        <p className="font-sans text-sm leading-relaxed text-foreground/70">
          However over images to see them in color!
        </p>
        <CatGallery />
      </div>
    </NierShell>
