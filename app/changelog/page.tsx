...
const changelog = [
  ...
  },
  {
    ...
    changes: [
      "Attended RustNL 2024 in Delft",
      "Attended EuroRust 2024 in Brussels",
      "Met cool people from the Rust community",
    ],
  },
  {
    version: "v1.3.0",
    ...
    <NierShell>
      <div className="flex flex-col gap-5">
        <p className="font-sans text-sm leading-relaxed text-foreground/70">
          A running log of life updates, styled like a software changelog.
          Semantic versioning applied loosely to human existence.
        </p>
              ...
              <ul className="flex flex-col gap-1.5">
                {entry.changes.map((change, j) => (
                  <li key={j} className="flex items-start gap-2.5">
                    <span
                      className="mt-1.5 inline-block h-1.5 w-1.5 shrink-0 bg-foreground/25"
                      aria-hidden="true"
                    />
