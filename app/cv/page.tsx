...
const experience = [
    ...
    },
    {
        ...
        company: "Fiberplane",
        description: "Backend development, developer tooling, cloud infrastructure",
    },
];
...
const skills = [
    {
        category: "Languages",
        items: "Rust, Go, TypeScript, JavaScript, Python, SQL, Java, C#, C++, Bash",
    },
    {
        category: "Frameworks",
        items: "Hono, Cloudflare, Svelte, gRPC, Boost, Actix Web, Tokio, sqlx, Django, Flask",
    },
    {
        category: "DevOps & Cloud",
        items: "Docker, Kubernetes, Terraform, AWS, GCP, Azure, Cloudflare, CI/CD, Git, Dependabot",
    },
    { category: "Databases", items: "MySQL, PostgreSQL, MSSQL" },
    {
        category: "Spoken",
        items: "German (native), Tagalog (native), English (fluent)",
    },
];
                ...
                <NierWindow title="Experience">
                    <div className="flex flex-col gap-5">
                        {experience.map((exp, i) => (
                            <div key={i} className="border-b border-border/20 pb-4 last:border-b-0 last:pb-0">
                                <div className="flex items-start justify-between gap-3">
                                    <div>
                                        <h4 className="font-sans text-sm font-medium text-foreground">{exp.title}</h4>
                                        <span className="font-sans text-xs text-muted-foreground">{exp.company}</span>
                                    </div>
                                    <span className="shrink-0 font-mono text-xs text-muted-foreground/60">{exp.period}</span>
                                </div>
                                <p className="mt-1.5 font-sans text-sm leading-relaxed text-foreground/80">{exp.description}</p>
                            </div>
                        ))}
                    </div>
                </NierWindow>
