                    ...
                    return (
                        <li key={item.id} className="flex items-center">
                            ...
                            <div className="flex w-5 shrink-0 items-center justify-center">
                                {isActive && (
                                    <svg width="10" height="10" viewBox="0 0 10 10" className="text-foreground" aria-hidden="true">
                            ...
                            <button
                                ...
                                className={`group flex w-full items-center gap-3 px-3 py-3 text-left transition-all duration-200 ${
                                    isActive ? "bg-foreground/90" : "bg-foreground/[0.07] hover:bg-foreground/[0.12]"
                                }`}
